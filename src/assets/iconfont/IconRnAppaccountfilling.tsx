...
let IconRnAppaccountfilling: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconRnAppaccountfilling.defaultProps = {
  size: 18,
};

IconRnAppaccountfilling = React.memo ? React.memo(IconRnAppaccountfilling) : IconRnAppaccountfilling;

export default IconRnAppaccountfilling;
