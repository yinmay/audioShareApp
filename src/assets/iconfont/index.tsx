...
export type IconNames = 'icon-rnAppnew' | 'icon-rnAppaccountfilling' | 'icon-rnAppaccount' | 'icon-rnApphome-filling' | 'icon-rnAppstar' | 'icon-rnAppstar-fill' | 'icon-rnApphome';
