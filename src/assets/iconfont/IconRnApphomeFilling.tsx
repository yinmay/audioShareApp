...
let IconRnApphomeFilling: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconRnApphomeFilling.defaultProps = {
  size: 18,
};

IconRnApphomeFilling = React.memo ? React.memo(IconRnApphomeFilling) : IconRnApphomeFilling;

export default IconRnApphomeFilling;
